...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        LeituraDados leituraDados = new LeituraDados(); // instância correta
        InsercaoBD insercaoBD = new InsercaoBD(conexao.getConexao());

        // Loop para inserir crimes/produtividade policial
        String[] municipios = {"Praia Grande", "Santos"};

        for (String municipio : municipios) {
            // Inserindo crimes
            Path caminhoCrime = Paths.get("OcorrenciaMensal(Criminal)-" + municipio + "_2025.xlsx");
            ...
            Path caminhoProdutividadePolicial = Paths.get("OcorrenciaMensal(ProdutividadePolicial)-" + municipio + "_2025.xlsx");
